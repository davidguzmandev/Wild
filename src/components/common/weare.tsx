...
export default function WeAre({ translations }: { translations: any }) {
  ...
  return (
    <section className="bg-slate-800 p-4 sm:p-6 md:p-10">
      <h3 className="font-black text-3xl sm:text-4xl md:text-6xl uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 flex flex-col sm:flex-row justify-center items-center text-center sm:text-left">
        ...
        <div className="g-container relative overflow-hidden flex">
          <ul className="root2 flex flex-col transition-transform duration-150 ease-linear">
            <li className="gli glimove bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-pink-400">
