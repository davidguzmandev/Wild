    ...
    <section
      ...
      <div className="max-w-full px-8 sm:px-6 lg:px-20 w-3/4 justify-center m-auto">
        <div className="text-center justify-center">
          <p className="text-5xl font-base pb-2 tracking-tight">{translations.projectinmind}</p>
          <p className="text-7xl font-bold pb-10 text-indigo-600">{translations.letstalk}</p>
