      ...
      <div className="max-w-full px-8 sm:px-6 lg:px-20">
        ...
        <div className="mx-32">
          ...
          <div className="my-10 flex gap-6">
            <div className="w-2/6 h-96 p-10 bg-cover bg-center" style={{backgroundImage: `url(${Uiux.src})`,}}>
              <p className="font-bold text-2xl mb-6">Diseño UI/UX</p>
              <p>
                Creamos interfaces graficas intuitivas para el usuario con optimizaciones funcionales en cada elemento del producto. 
              </p>
            </div>
            <div className="w-3/6 space-y-6">
              <div className="h-50 p-10 bg-blue-600">
                <p>Card1</p>
                <p>
              ...
              <div className="h-40 p-10 bg-blue-600">
                <p>Card1</p>
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Alias odio dolore eos esse vel repellat corporis sed quas ut,
            ...
            <div className="w-1/6 h-96 p-10 bg-blue-600">
                <p>Card1</p>
                <p>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Alias odio dolore eos esse vel repellat corporis sed quas ut,
